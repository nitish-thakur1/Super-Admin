...
import BringMeFeedbackModal from "./bringMe-feedback";
...
const FeedbackModal = ({ show, handleClose }: Prop) => {
...
const [bringMefeedbackModal,bringMeFeedback,]=useState(false)

  const handleModalOpen=()=>{
    bringMeFeedback(true)
    handleClose()
  }
...
<BringMeFeedbackModal show={bringMefeedbackModal} handleClose={()=>bringMeFeedback(false)}/>
